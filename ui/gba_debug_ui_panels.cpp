...
void gba_draw_panel_gpu(struct gba *gba)
{
                               ...
                               ImGuiTableFlags_RowBg | ImGuiTableFlags_SizingFixedFit))
     {
          ...
          for (int i = 0; i < 4; i++)
          {
               ...
               ImGui::TextColored(gpu->bg_en[i] ? col_green : col_gray, "BG%d", i);
               ImGui::TableNextColumn();
               ImGui::Text("%u", bg->priority);
               ImGui::TableNextColumn();
               ImGui::Text("%u", bg->tile_base);
               ImGui::TableNextColumn();
               ImGui::Text("%u", bg->map_base);
               ImGui::TableNextColumn();
               ImGui::Text("%u", bg->size);
               ImGui::TableNextColumn();
               ImGui::Text("%u", bg->hofs);
               ImGui::TableNextColumn();
               ImGui::Text("%u", bg->vofs);
          }
          ImGui::EndTable();
     }
...
void gba_draw_panel_apu(struct gba *gba)
{
     ...
     ImGui::Text("Mute:");
     ImGui::SameLine();
     ImGui::Checkbox("CH1##m", &apu->mute_ch1);
     ImGui::SameLine();
     ImGui::Checkbox("CH2##m", &apu->mute_ch2);
     ImGui::SameLine();
     ImGui::Checkbox("CH3##m", &apu->mute_ch3);
     ImGui::SameLine();
     ImGui::Checkbox("CH4##m", &apu->mute_ch4);
     ImGui::SameLine();
     ImGui::Checkbox("FIFO A##m", &apu->mute_fifo_a);
     ImGui::SameLine();
     ImGui::Checkbox("FIFO B##m", &apu->mute_fifo_b);
...
void gba_draw_panel_profiler(struct gba *gba)
{
                               ...
                               ImGuiTableFlags_SizingFixedFit))
     {
          ...
          for (int i = 0; i < GBA_EVENT_TRACE_SIZE; i++)
          {
               ...
               ImGui::Text("%08x", e->pc);
               ImGui::TableNextColumn();
               ImGui::Text("%08x", e->target);
               ImGui::TableNextColumn();
               ImGui::Text("%u", e->detail);
          }
          ImGui::EndTable();
     }
}
